am4core.ready(function() {
  ...
  var chart = am4core.create("chart_14", am4maps.MapChart);
...
polygonSeries.include = ["SA"
  ...
  pieSeries.data = [{ value: 4.9, category: "Below 1b" }, { value: 21.7, category: "Level 1b" }, { value: 35.6, category: "Level 1a" },  { value: 26.6, category: "Level 2" },  { value: 9.6, category: "Level 3" }, { value: 4, category: "Level 4"}, { value: 0.1, category: "Level 5"}];
  ...
  countryLabel.text = "Click to see level distribution";
  ...
  function zoomToCountry(polygon) {
      var zoomAnimation = chart.zoomToMapObject(polygon, .5, true);
      if (zoomAnimation) {
